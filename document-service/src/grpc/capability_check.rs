//! Capability enforcement for document-service gRPC endpoints.
//!
...
//!
//! By default, document-service uses a BFF trust model where the upstream
...
/// Capability checker for document operations.
///
...
impl CapabilityChecker {
    ...
    ///
    /// # Returns
    /// * `Ok(())` - Capability granted or checking disabled
