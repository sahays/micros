...
ALL_SERVICES=("auth-service" "service-core" "document-service" "genai-service" "notification-service" "ledger-service" "payment-service" "invoicing-service" "billing-service" "reconciliation-service")
