...
async fn run_billing_for_subscription_works() {
    ...
    let subscription =
        create_test_subscription(&mut client, app.tenant_id(), "Billing Run Plan").await;
...
async fn get_billing_run_works() {
    ...
    let _subscription =
        create_test_subscription(&mut client, app.tenant_id(), "Get Run Plan").await;
...
async fn list_billing_runs_works() {
    ...
    let _subscription =
        create_test_subscription(&mut client, app.tenant_id(), "List Runs Plan").await;
...
async fn list_billing_runs_filters_by_status() {
    ...
    let _subscription =
        create_test_subscription(&mut client, app.tenant_id(), "Filter Runs Plan").await;
