...
mod capability_constants_tests {
    // Define capability constants locally since they are service-specific string constants
    // originally from reconciliation_service::grpc::capability_check::capabilities
    mod capabilities {
