...
mod capability_constants_tests {
    use ledger_service::grpc::capability_check::capabilities;

    #[test]
    fn ledger_capabilities_are_defined() {
        assert_eq!(capabilities::LEDGER_ACCOUNT_CREATE, "ledger.account:create");
        assert_eq!(capabilities::LEDGER_ACCOUNT_READ, "ledger.account:read");
        assert_eq!(capabilities::LEDGER_ACCOUNT_UPDATE, "ledger.account:update");
        assert_eq!(
            capabilities::LEDGER_TRANSACTION_CREATE,
            "ledger.transaction:create"
        );
        assert_eq!(
            capabilities::LEDGER_TRANSACTION_READ,
            "ledger.transaction:read"
        );
        assert_eq!(capabilities::LEDGER_BALANCE_READ, "ledger.balance:read");
        assert_eq!(capabilities::LEDGER_STATEMENT_READ, "ledger.statement:read");
        assert_eq!(
            capabilities::LEDGER_TRANSACTION_REVERSE,
