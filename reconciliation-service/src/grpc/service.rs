...
impl reconciliation_service_server::ReconciliationService for ReconciliationServiceImpl {
    ...
    async fn get_bank_account(
        ...
        bank_accounts::get_bank_account(&self.db, request).await
    }
    ...
    async fn list_bank_accounts(
        ...
        bank_accounts::list_bank_accounts(&self.db, request).await
    }
    ...
    async fn update_bank_account(
        ...
        bank_accounts::update_bank_account(&self.db, request).await
    }
    ...
    async fn import_statement(
        ...
        statements::import_statement(&self.db, request).await
    }
    ...
    async fn get_statement(
        ...
        statements::get_statement(&self.db, request).await
    }
    ...
    async fn list_statements(
        ...
        statements::list_statements(&self.db, request).await
    }
    ...
    async fn get_staged_transactions(
        ...
        statements::get_staged_transactions(&self.db, request).await
    }
    ...
    async fn update_staged_transaction(
        ...
        statements::update_staged_transaction(&self.db, request).await
    }
    ...
    async fn commit_statement(
        ...
        statements::commit_statement(&self.db, request).await
    }
    ...
    async fn abandon_statement(
        ...
        statements::abandon_statement(&self.db, request).await
    }
    ...
    async fn create_matching_rule(
        ...
        matching::create_matching_rule(&self.db, request).await
    }
    ...
    async fn get_matching_rule(
        ...
        matching::get_matching_rule(&self.db, request).await
    }
    ...
    async fn list_matching_rules(
        ...
        matching::list_matching_rules(&self.db, request).await
    }
    ...
    async fn update_matching_rule(
        ...
        matching::update_matching_rule(&self.db, request).await
    }
    ...
    async fn delete_matching_rule(
        ...
        matching::delete_matching_rule(&self.db, request).await
    }
    ...
    async fn match_transaction(
        ...
        matching::match_transaction(&self.db, request).await
    }
    ...
    async fn unmatch_transaction(
        ...
        matching::unmatch_transaction(&self.db, request).await
    }
    ...
    async fn exclude_transaction(
        ...
        matching::exclude_transaction(&self.db, request).await
    }
    ...
    async fn get_ai_suggestions(
        ...
        matching::get_ai_suggestions(request).await
    }
    ...
    async fn confirm_suggestion(
        ...
        matching::confirm_suggestion(request).await
    }
    ...
    async fn reject_suggestion(
        ...
        matching::reject_suggestion(request).await
    }
    ...
    async fn get_reconciliation(
        ...
        reconciliation::get_reconciliation(&self.db, request).await
    }
    ...
    async fn list_reconciliations(
        ...
        reconciliation::list_reconciliations(&self.db, request).await
    }
    ...
    async fn complete_reconciliation(
        ...
        reconciliation::complete_reconciliation(&self.db, request).await
    }
    ...
    async fn abandon_reconciliation(
        ...
        reconciliation::abandon_reconciliation(&self.db, request).await
    }
    ...
    async fn create_adjustment(
        ...
        reconciliation::create_adjustment(&self.db, request).await
    }
    ...
    async fn list_adjustments(
        ...
        reconciliation::list_adjustments(&self.db, request).await
    }
}
