...
// ============================================================================
// Integration Tests (Require Auth Service)
// ============================================================================

/// Integration tests that require a running auth-service.
///
/// These tests are ignored by default and can be run with:
/// ```bash
/// AUTH_SERVICE_ENDPOINT=http://localhost:9005 cargo test --test capability_test -- --ignored
/// ```
#[cfg(test)]
mod integration_tests {
    ...
    async fn unauthenticated_request_is_rejected() {
        // This test would:
        // 1. Connect to reconciliation-service with auth enabled
        // 2. Send request WITHOUT Authorization header
        // 3. Expect Status::Unauthenticated
        todo!("Implement with auth-service integration");
    }
    ...
    /// Test that requests without required capability are denied.
    #[tokio::test]
    #[ignore = "Requires running auth-service"]
    async fn missing_capability_is_denied() {
        // This test would:
        // 1. Create user WITHOUT reconciliation.bank_account:create capability
        // 2. Attempt to call register_bank_account
        // 3. Expect Status::PermissionDenied
        todo!("Implement with auth-service integration");
    }

    /// Test that requests with required capability succeed.
    #[tokio::test]
    #[ignore = "Requires running auth-service"]
    async fn valid_capability_allows_request() {
        // This test would:
        // 1. Create user WITH reconciliation.bank_account:create capability
        // 2. Call register_bank_account
        // 3. Expect success
        todo!("Implement with auth-service integration");
    }
}
