//! Capability enforcement for payment-service gRPC endpoints.
//!
...
//!
//! By default, payment-service uses a BFF trust model where the upstream
...
/// Capability checker for Payment operations.
///
