//! Capability enforcement for genai-service gRPC endpoints.
//!
...
//!
//! By default, genai-service uses a BFF trust model where the upstream
...
/// Capability checker for GenAI operations.
///
