...
use invoicing_service::config::{DatabaseConfig, InvoicingConfig, LedgerServiceConfig};
...
fn unique_schema_name() -> String {
    ...
    format!("test_inv_{}_{}", std::process::id(), counter)
}
...
impl TestApp {
    ...
    pub async fn spawn() -> Self {
        ...
        let config = InvoicingConfig {
            ...
            service_name: "invoicing-service-test".to_string(),
            ...
            ledger_service: LedgerServiceConfig {
                url: "http://localhost:50052".to_string(), // May not be available in tests
            },
        };
    ...
    pub async fn grpc_client(
        &self,
    ) -> invoicing_service::grpc::proto::invoicing_service_client::InvoicingServiceClient<
        tonic::transport::Channel,
    > {
        invoicing_service::grpc::proto::invoicing_service_client::InvoicingServiceClient::connect(
